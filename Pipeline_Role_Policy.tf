...
resource "aws_iam_policy" "AmazonEC2RoleforAWSCodeDeploy" {
  name        = "AmazonEC2RoleforAWSCodeDeploy"
  description = "Permissions for EC2 instances to work with AWS CodeDeploy."
...
resource "aws_iam_role_policy_attachment" "EC2_codedeploy_policy_attachment" {
  role       = "EC2_CodeDeploy_Role"  
  policy_arn = aws_iam_policy.AmazonEC2RoleforAWSCodeDeploy.arn
}
...
resource "aws_iam_policy_attachment" "EC2_codedeploy_role_attachment" {
  name = "AmazonEC2RoleforAWSCodeDeploy"
  policy_arn = aws_iam_policy.AmazonEC2RoleforAWSCodeDeploy.arn
